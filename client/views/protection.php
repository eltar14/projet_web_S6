...
<section id="intro" class="main_content">
    <h1>
        Vau dauner y son protaijai
    </h1>
    <hr>
    <h2>Je m'apèle Raubér et ge prautaije vaux donné</h2>
    <div>    <img style="max-width: 900px" src="../views/img/guard.jpg" alt="garde_robert">
    </div>
    <p>Robert est la pour protéger vos données (je crois)</p>
</section>
