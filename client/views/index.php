...
<section id="intro" class="main_content">
    ...
    <h2>Carte</h2>
    <div>
        <iframe width="100%" height="600" src="https://www.openstreetmap.org/export/embed.html?bbox=3.2504946736681366%2C49.8337201059942%2C3.3130223302233124%2C49.85502958138684&amp;layer=mapnik" style="border: 1px solid black"></iframe><br/><small><a href="https://www.openstreetmap.org/#map=15/49.8444/3.2818">Afficher une carte plus grande</a></small>
    </div>
